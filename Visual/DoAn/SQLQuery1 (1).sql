...
go
create procedure DKPTN (@Ngaydk date,@Buoi nchar(10),@nhom nchar(10),@GVQL nchar(10),@loaiTN nchar(10),@ptn nchar(10),@Tb nchar(10))
as
begin
	if ((select count(*) from DK_PTN where NgayDK=@Ngaydk and MaNhom=@nhom and MaBuoi=@Buoi) >= 1)
		...
		insert into DK_PTN values(@Ngaydk,@Buoi,@nhom,@GVQL,@loaiTN,@ptn,@tb);
	return 1;
end;
...
values('2001160180', N'Minh Khai Hoa', 7, 2019,'TP10','CNTP01');
go
insert into SinhVien
values('2001150120', N'Linh Thị Hoa', 7, 2019,'TP10','CNTP01');
go
insert into SinhVien
values('2001160220', N'Bông Thị Cúc', 7, 2019,'TP01','CNTP01');
go
insert into SinhVien
values('2001162150', N'Minh Ngộ Lý',7, 2019,'TP01','CNTP01');
go
insert into SinhVien
values('2001160080', N'Kinh Tại Tây', 7, 2019,'TP02','CNTP02');
go
insert into SinhVien
values('2001160188', N'Kinh Hà Giang', 7, 2019,'TP02','CNTP02');
go
insert into SinhVien
values('2001160178', N'Thủy Ngậm Tự', 7, 2019,'TP02','CNTP02');
go
insert into SinhVien
values('2001160191', N'Tự Từ Hối', 7, 2019,'TP03','CNTP02');
go
insert into SinhVien
values('2001160345', N'Hối Vô Phương', 7, 2019,'TP03','CNTP01');
go
insert into SinhVien
values('2001160678', N'Phương Tái Ngẫm', 7, 2019,'TP04','CNTP01');
go
insert into SinhVien
values('2001160985', N'Ngẫm Vô Nghĩ', 7, 2019,'TP05','CNTP01');
go
insert into SinhVien
values('2001163557', N'Nghĩ Tức Thông', 7, 2019,'TP05','CNTP01');
go
insert into SinhVien
values('2001163537', N'A B C', 7, 2019,'TP06','CNTP01');
go
insert into SinhVien
values('2001163337', N'C S D', 7, 2019,'TP06','CNTP02');
go
insert into SinhVien
values('2001161227', N'O A B', 7, 2019,'TP07','CNTP02');
go
insert into SinhVien
values('2001161217', N'L O H', 7, 2019,'TP07','CNTP01');
go
insert into SinhVien
values('2001161117', N'U I O', 7, 2019,'TP08','CNTP02');
go
insert into SinhVien
values('2001162227', N'A W E', 7, 2019,'TP08','CNTP01');
go
insert into SinhVien
values('2001162147', N'Q E D', 7, 2019,'TP09','CNTP01');
go
insert into SinhVien
values('2001160777', N'Y I K', 7, 2019,'TP09','CNTP02');
go
insert into DungCu
...
go
insert into PhongThiNghiem values('PTN01','Phòng thí nghiệm 01');
go
insert into PhongThiNghiem values('PTN02','Phòng thí nghiệm 02');
go
insert into PhongThiNghiem values('PTN03','Phòng thí nghiệm 03');
go
exec DKPTN '1/1/2020','B1','TP01','GVQL01','TNTH','PTN01','TB01';
go
exec DKPTN '1/1/2020','B1','TP02','GVQL01','TNTH','PTN01','TB04';
go
exec DKPTN '1/1/2020','B1','TP03','GVQL01','TNTH','PTN01','TB10';
go
exec DKPTN '1/1/2020','B1','TP04','GVQL01','THTH','PTN01','TB05';
go
exec DKPTN '1/1/2020','B1','TP05','GVQL01','TNTH','PTN02','TB08';
go
exec DKPTN '1/1/2020','B2','TP06','GVQL01','THTH','PTN01','TB07';
go
exec DKPTN '2/1/2020','B1','TP02','GVQL01','TNTH','PTN02','TB01';
go
exec DKPTN '2/1/2020','B2','TP07','GVQL01','TNTH','PTN01','TB02';
go
exec DKPTN '3/1/2020','B1','TP08','GVQL01','TNTH','PTN01','TB04';
go
